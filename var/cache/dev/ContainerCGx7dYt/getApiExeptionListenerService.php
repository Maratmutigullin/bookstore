...
class getApiExeptionListenerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['App\\Listener\\ApiExeptionListener'] = new \App\Listener\ApiExeptionListener(new \App\Service\ExeptionHandler\ExeptionMappingResolver($container->parameters['exeptions']), ($container->privates['monolog.logger'] ?? $container->load('getMonolog_LoggerService')), ($container->services['.container.private.serializer'] ?? $container->load('get_Container_Private_SerializerService')));
    }
}
