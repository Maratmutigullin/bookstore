...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\BookCategoryController' => 'getBookCategoryControllerService',
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.exception', [0 => function () {
            return ($this->privates['App\\Listener\\ApiExeptionListener'] ?? $this->load('getApiExeptionListenerService'));
        }, 1 => '__invoke'], 10);
        $instance->addListener('kernel.exception', [0 => function () {
            return ($this->privates['App\\Listener\\ValidationExceptionListener'] ?? $this->load('getValidationExceptionListenerService'));
        }, 1 => '__invoke'], 15);
    ...
    protected function getHttpKernelService()
    {
        ...
        return $this->services['http_kernel'] = new \Symfony\Component\HttpKernel\HttpKernel(($this->services['event_dispatcher'] ?? $this->getEventDispatcherService()), new \Symfony\Component\HttpKernel\Controller\TraceableControllerResolver(new \Symfony\Bundle\FrameworkBundle\Controller\ControllerResolver($this, ($this->privates['monolog.logger.request'] ?? $this->getMonolog_Logger_RequestService())), $a), ($this->services['request_stack'] ?? ($this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())), new \Symfony\Component\HttpKernel\Controller\TraceableArgumentResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver(new \Symfony\Component\HttpKernel\ControllerMetadata\ArgumentMetadataFactory(), new RewindableGenerator(function () {
            ...
            yield 3 => ($this->privates['debug.App\\ArgumentResolver\\RequestBodyArgumentResolver'] ?? $this->load('getRequestBodyArgumentResolverService'));
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6is8oBDECT', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'exceptions' => [
                'App\\Exception\\BookCategoryNotFoundException' => [
                    'code' => 404,
                    'hidden' => false,
                ],
                'App\\Exception\\SubscriberEmailExistsExeption' => [
                    'code' => 409,
                    'hidden' => false,
                ],
