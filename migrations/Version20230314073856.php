 ...
 */
final class Version20230314073856 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book_chapter (id INT NOT NULL, book_id INT NOT NULL, parent_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, sort INT DEFAULT 0 NOT NULL, level INT NOT NULL, PRIMARY KEY(id))');
