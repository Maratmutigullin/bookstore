 ...
 */
final class Version20230116093538 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book_to_book_format (id INT NOT NULL, book_id INT NOT NULL, book_to_book_format_id INT NOT NULL, price NUMERIC(10, 2) NOT NULL, discount_percent INT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE review (id INT NOT NULL, book_id INT NOT NULL, reating INT NOT NULL, content TEXT NOT NULL, author VARCHAR(255) NOT NULL, created_at DATE NOT NULL, PRIMARY KEY(id))');
