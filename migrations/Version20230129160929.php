 ...
 */
final class Version20230129160929 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP SEQUENCE book_category_id_seq1 CASCADE');
        ...
        $this->addSql('CREATE TABLE book (id INT NOT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(255) DEFAULT NULL, image VARCHAR(255) NOT NULL, autors TEXT NOT NULL, publication_date DATE DEFAULT NULL, meap BOOLEAN DEFAULT false NOT NULL, isbn VARCHAR(13) NOT NULL, description TEXT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('COMMENT ON COLUMN book.autors IS \'(DC2Type:simple_array)\'');
        ...
        $this->addSql('CREATE TABLE review (id INT NOT NULL, book_id INT NOT NULL, reating INT NOT NULL, content TEXT NOT NULL, author VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE SEQUENCE book_category_id_seq1 INCREMENT BY 1 MINVALUE 1 START 1');
